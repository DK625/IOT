...
const HumidityLimit = () => {
    ...
    const handleOKClick = () => {
        ...
        const changeLimitPayload = { action_name: 'change limit', status: `${lowerLimit}% - ${upperLimit}%`, "device_name": "Độ ẩm" };
        ...
        <CRow>
            <CCol xs={12}>
                <CCard className="mb-4 limit-input-page">
                    <CCardHeader>
                        <strong>Nhập Giới Hạn Độ ẩm</strong>
                    </CCardHeader>
                    <CCardBody>
                        <div>
